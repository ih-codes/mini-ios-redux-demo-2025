...
/// A unique identifier for a particular window in Firefox iOS. On iPad this UUID corresponds to an individual window which
/// manages its own unique set of tabs. Multiple Firefox windows can be run side-by-side on iPad (once multi-window is
/// enabled). [FXIOS-7349]
